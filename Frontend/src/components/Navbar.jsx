...
function Navbar() {
  ...
  useEffect(()=>{
    ...
    <li><Link  to="/views">View All Users</Link></li>
  ...
  return (
      ...
      <>
      <div className={` w-full dark:bg-slate-800  dark:text-white fixed  top-0 left-0 right-0  z-99${
        sticky?"sticky-navbar shadow-md bg-base-200 light:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out":""
      }`}>
      <div className="navbar max-w-screen-2xl container mx-auto md:px-20 px-4">
  <div className="navbar-start">
    <div className="dropdown">
      <div tabindzex={0} role="button" className="btn btn-ghost lg:hidden">
    ...
    <a className="text-3xl  font-bold cursor-pointer text-pink-500 mt-2">Online Banking</a>
  </div>
